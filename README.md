...
Essentials is a CSS reset framework build on [LESS](http://lesscss.org/) which allows you to build websites with your own components. for more details on building your own components check out [custom build](#custom-build). The main focus on this project is as follows:
