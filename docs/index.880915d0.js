...
null == r &&
    ...
    (e.parcelRequire0b36 = r)),
    (0, r.register)('aES5g', function (e, n) {
        function a() {
        ...
        t(e.exports, 'setDataAttr', () => a),
            t(e.exports, 'removeDataAttr', () => r),
            t(e.exports, 'getDataAttr', () => o),
...
function s(...t) {
    ...
    function a() {
        e.forEach((t) => {
            n.has(t.dataset.toggle) && t.removeDataAttr('state');
        });
    }
    function r(t) {
        const e = t.closestDataAttr('dropbox'),
            n = t.hasDataAttr('state');
        e || n || a(), t.toggleDataAttr('state', 'active');
    }
    return (
        document.addEventListener('click', (t) => {
            const n = t.target.closestDataAttr('toggle');
            if (n) {
                if (e.has(n)) return;
                e.add(n),
                    n.addEventListener(
...
class l {
    constructor() {
        l.init(), (this.toggle = s), (this.callback = i);
    }
    static init() {
        (0, o.setDataAttr)(),
            (0, o.removeDataAttr)(),
...
const c = new l(),
    ...
    p = {
        _string(t, e) {
            const n = t.trim();
            document.querySelector(e).insertAdjacentHTML('beforeend', n);
        },
        _append(t, e, n) {
        ...
        append(t, e, n = null) {
            return (
                new Promise((e, n) => {
                    ...
                    .then(() => this._append(document, t, e))
                    .then(() => {
                        c.callback(n);
                    })
                    .catch((t) =>
                        console.error(t, 'Error: Template not found')
                    ),
                this
            );
        },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    'fullPage' === meta.type &&
        ...
        p
            ...
            .append('#contentTemplate', '#content', d)
            .fetch(t, '#navTemplate', 'nav')
            .fetch(t, '#footerTemplate', 'body > footer'),
        c.toggle();
});
